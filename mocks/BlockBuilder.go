...
func (_m *BlockBuilder) SetTxs(txs *trie.FixedLengthHexKeyMerkleTrie) api.BlockBuilder {
	ret := _m.Called(txs)

	var r0 api.BlockBuilder
	if rf, ok := ret.Get(0).(func(*trie.FixedLengthHexKeyMerkleTrie) api.BlockBuilder); ok {
		r0 = rf(txs)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(api.BlockBuilder)
...
func (_m *BlockBuilder) Txs() *trie.FixedLengthHexKeyMerkleTrie {
	ret := _m.Called()

	var r0 *trie.FixedLengthHexKeyMerkleTrie
	if rf, ok := ret.Get(0).(func() *trie.FixedLengthHexKeyMerkleTrie); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*trie.FixedLengthHexKeyMerkleTrie)
		}
	}
